        ...
        <?php endif; ?>
                        ...
                        <div class="card-body">
                            <form role="form" method="post" action="<?= base_url('/login') ?>">
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-lg bg-gradient-dark btn-lg w-100 mt-4 mb-0">Connexion</button>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="card-footer text-center pt-0 px-lg-2 px-1">
                            <p class="mb-2 text-sm mx-auto">
                                ...
                                <a href="<?= base_url('register');?>" class="text-primary text-gradient font-weight-bold">S'inscrire</a>
                            </p>
                        </div>
                    </div>
